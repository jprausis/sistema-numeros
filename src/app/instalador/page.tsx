...
export default function InstallerDashboard() {
    ...
    const handleProcess = (property: any) => {
        if (linkingAgendamento) {
            router.push(`/instalador/imovel/${property.inscimob}?agendamento=${linkingAgendamento.protocolo}&nome=${encodeURIComponent(linkingAgendamento.nome)}&telefone=${encodeURIComponent(linkingAgendamento.telefone)}`);
        } else {
